...
/// <summary>
/// Single ambient <see cref="ILogger"/>. The log category is
/// <c>"IfcEnvelopeMapper"</c>, separable from xBIM's output (<c>"Xbim.*"</c>)
/// via standard <see cref="ILoggerFactory"/> filters. Before
/// <see cref="Configure"/> is called, <see cref="Log"/> returns
...
public static class AppLog
{
    ...
    /// <summary>
    /// Wires <paramref name="factory"/> as the source of <see cref="Log"/>.
    /// Must be called before any code path that logs.
    /// </summary>
