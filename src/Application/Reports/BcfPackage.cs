...
/// <summary>
/// Package-level record. One <see cref="BcfPackage"/> serialises to one
...
/// </summary>
public sealed record BcfPackage(
    string                  Version,
...
/// <see cref="Domain.Interfaces.IElement"/> GlobalId the receiving tool
/// should highlight when the topic is opened.
/// </summary>
