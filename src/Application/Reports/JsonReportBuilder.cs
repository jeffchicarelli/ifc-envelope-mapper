...
/// <summary>
/// Builds a <see cref="DetectionReport"/> from a <see cref="DetectionResult"/> plus the run metadata the strategy itself doesn't carry (input
/// path, strategy name, configuration, elapsed time).
/// </summary>
public static class JsonReportBuilder
{
    ...
    public static DetectionReport Build(string ifcPath, string strategy, StrategyConfig config, DetectionResult result, TimeSpan duration)
    {
