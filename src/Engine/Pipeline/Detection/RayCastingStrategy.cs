...
/// </list>
/// </remarks>
public sealed class RayCastingStrategy : IEnvelopeDetector
{
    ...
    private static (DMesh3 mesh, Element[] triToElement) MergeMeshes(
        List<Element> elements)
    {
        var merged = new DMesh3();
        var owners = new List<Element>(elements.Sum(e => e.GetMesh().TriangleCount));
