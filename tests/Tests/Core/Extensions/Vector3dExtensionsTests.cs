...
public class Vector3DExtensionsTests
{
    ...
    {
        // All four points lie on z = 5 — a fitted plane should have zero signed
        // distance to each of them. Plane3d uses the Hessian form
        // Normal · X = Constant, so the signed distance is Normal·P − Constant.
        var points = new[]
        {
            new Vector3d(2, 3, 5),
            new Vector3d(4, 3, 5),
