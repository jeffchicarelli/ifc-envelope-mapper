...
// a real IElement (xBIM IIfcProduct-backed), so algorithm tests on non-trivial
...
// ──────────────────────────────────────────────────────────────────────────────
// Integration tests — real faces from duplex.ifc via VoxelFloodFillDetector.
//
// Why VoxelFloodFillDetector and not RayCasting?
